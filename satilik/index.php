          ...
          <div class="modal-body">
            ...
            <table>
              ...
              <tr>
                ...
                <td> <?php echo $kullanici["EsyDurumu"] ?></td>
              </tr>
              <tr>
...
<!-- FOOTER -->
    ...
    <div class="col-lg-6 col-md-12 mb-4 mb-md-0" style="padding: 30px;">
      <p style="color: #f0a500;">Adres Bilgileri İçin :</p>
        <img src="../qrcode.jpeg" width="120px" height="120px" alt="">
        <br><br><br><br><br><br>
    ...
    <a class="" style="color: #f0a500;" href="https://mdbootstrap.com/">mygoldgayrimenkul.com</a>
  </div>
  <!-- Copyright -->
    </footer>
<!-- FOOTER -->
